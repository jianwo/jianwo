  ...
  stir.render stir.doctype(),
    html null,
      head null,
        ...
        meta name: 'author', content: '席地'
        meta name: 'description', content: '席地是一个团队协作即时通讯工具, 拥有多种消息文本类型, 话题, 内容分享, 搜索, 文件整理以及一系列精彩的功能. 我们希望你的团队能通过席地变得更有效率'
        meta name: 'keywords', content: '分享, 工作, 沟通, 话题, 即使通讯, 团队协作, 效率'
        meta name: 'apple-itunes-app', content: 'app-id=922425179'
        meta property: 'og:description', content: '席地是一个团队协作即时通讯工具, 拥有多种消息文本类型, 话题, 内容分享, 搜索, 文件整理以及一系列精彩的功能. 我们希望你的团队能通过席地变得更有效率'
        meta property: 'og:image', content: 'https://dn-talk.oss.aliyuncs.com/icons/preview.png'
        meta property: 'og:site_name', content: '席地'
        meta property: 'og:title', content: '席地 | 谈工作，用席地'
